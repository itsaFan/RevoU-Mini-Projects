      ...
      <CardBorder title="Add Task">
        <form onSubmit={handleFormSubmit}>
          <div className="">
            ...
            <div>
              <select name="project" value={formData.project} onChange={handleInputChange} className="w-full h-10 border border-gray-800 px-3 rounded-lg" required>
          ...
          <div>
            ...
            <div>
              <input type="text" name="title" value={formData.title} onChange={handleInputChange} className="w-full h-10 border border-gray-800 px-3 rounded-lg" required />
            </div>
          </div>
          <div>
            <label className="font-semibold">Description:</label>
            <div>
              <input type="text" name="description" value={formData.description} onChange={handleInputChange} className="w-full h-10 border border-gray-800 px-3 rounded-lg" required />
            </div>
          </div>
          <div>
            <label className="font-semibold">Due Date:</label>
            <div>
              <input type="date" name="dueDate" value={formData.dueDate} onChange={handleInputChange} className="w-full h-10 border border-gray-800 px-3 rounded-lg" required />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div>
              <select name="assignedTo" value={formData.assignedTo} onChange={handleInputChange} className="w-full h-10 border border-gray-800 px-3 rounded-lg" required>
